...
var ItemMasterView = {
    ...
    initializeJqgrid: function (url) {
        ...
        var url = "/Common/BindMastersDetails?ServiceName=ITEMMASTER_GET&myfilters=" + JSON.stringify(myfilter);

        var colNames = ['ItemId', 'Item Name', 'Short Name', 'ItemGroup', 'Item Group Name', 'ITEMTYPE', 'HSNID', 'Size Maintain', 'Auto MRP In Tag', 'Is Active', 'HSN Code', 'Item Type', 'Price','Stock Qty','Rent Stock','Available Stock Qty'];
        var colModel = [
            ...
            { name: "STOCKQTY", width: 5, index: "STOCKQTY", xmlmap: xmlvars.common_colmap + "STOCKQTY", stype: 'int', sortable: true, searchoptions: jqGridVariables.stringSearchOption, align: "center" },
            { name: "RENTSTOCKQTY", width: 5, index: "RENTSTOCKQTY", xmlmap: xmlvars.common_colmap + "RENTSTOCKQTY", stype: 'int', sortable: true, searchoptions: jqGridVariables.stringSearchOption, align: "center" },
            { name: "AVAILABLESTOCKQTY", width: 8, index: "AVAILABLESTOCKQTY", xmlmap: xmlvars.common_colmap + "AVAILABLESTOCKQTY", stype: 'int', sortable: true, searchoptions: jqGridVariables.stringSearchOption, align: "center" },
    ...
    bindItemGroup: function () {
        $("#ddlItemGroup").html("");
        BindDropdown('ddlItemGroup', 'GroupDropdownList', getDomain() + "/Common/BindMastersDetails?ServiceName=ITEMGROUPMASTER_GET&IsRecordAll=true&ISACTIVE=1&COLUMNREQUESTED=ITEMGROUPMASTERID&COLUMNREQUESTED=ITEMGROUPNAME,ITEMGROUPMASTERID", '-- All Item Group --', true);
    },
...
$(document).ready(function () {
    try {
        ...
        /*var url = ItemMasterView.variables.BindMasterUrl + JSON.stringify(myfilter);*/
