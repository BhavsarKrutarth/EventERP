    ...
    $.fn.nthTabs = function (options) {
        ...
        var methods = {
            ...
            getAllTabWidth: function () {
                var sum_width = 0;
                nthTabs.find('.actosoft-tabs li').each(function () {
            ...
            getTabList: function () {
                var tabList = [];
                nthTabs.find('.actosoft-tabs li a').each(function () {
            ...
            addTab: function (options) {
                ...
                tab.push('<a href="#' + options.id + '" data-toggle="tab" id="id' + options.id + '">');
                tab.push('<span>' + options.title + '</span>');
                allowClose ? tab.push('<i class="icon nth-icon-close-mini tab-close"></i>') : '';
                tab.push('</a>');
                tab.push('</li>');
                nthTabs.find(".actosoft-tabs").append(tab.join(''));
                //tab-content
                var tabContent = [];
                tabContent.push('<div class="tab-pane ' + (fadeIn ? 'animation-fade' : '') + '" id="' + options.id + '">');
                if (url.length > 0) {
                    tabContent.push('<iframe src="' + options.url + '" frameborder="0" name="iframe-' + frameName + '" class="nth-tabs-frame" id="iframe' + options.id + '"></iframe>');
                    frameName++;
                } else {
            ...
            delOtherTab: function () {
                nthTabs.find(".actosoft-tabs li").not('[class="active"]').remove();
            ...
            delAllTab: function () {
                nthTabs.find(".actosoft-tabs li").remove();
        ...
        var event = {
            ...
            onTabClose: function () {
                nthTabs.on("click", '.tab-close', function () {
                    ...
                    $(".content-tabs-container").css('margin-left', 40);
                });
                return this;
            },
            ...
            onTabRollLeft: function () {
                nthTabs.on("click", '.roll-nav-left', function () {
                    ...
                    if (settings.rollWidth == -122) {
                        settings.rollWidth = 1227;
                    }
